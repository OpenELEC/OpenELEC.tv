...
couchpotatov2_launch = getAddonSetting(suiteSettings, 'COUCHPOTATOV2_LAUNCH')
...
#defaultConfig['core']['password']            = pwd
...
defaultConfig['core']['permission_folder']   = '0755'
defaultConfig['core']['permission_file']     = '0755'
...
# ------------------
if "true" in couchpotatov2_launch:
